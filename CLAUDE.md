...
- `app/(main)/` — Main app group with nav drawer layout (`NavDrawer`)
  ...
  - `eureka/loading.tsx` — Loading skeleton for eureka list
  ...
  - `eureka/missing/loading.tsx` — Loading skeleton
  - `eureka/trials/page.tsx` — Trials view
  - `eureka/trials/loading.tsx` — Loading skeleton
...
- `components/forms/auth/` — login-form, sign-up-form, forgot-password-form, update-password-form, profile-form
