...
export default function SettingsTabs({
  ...
  return (
    <Box>
      ...
      >
        {isLoggedIn && <Tab label="Profile" sx={{ flexGrow: { sm: 1, md: 0 } }} value="profile" />}
        <Tab label="Appearance" sx={{ flexGrow: { sm: 1, md: 0 } }} value="appearance" />
        {isLoggedIn && <Tab label="Account" sx={{ flexGrow: { sm: 1, md: 0 } }} value="account" />}
      </Tabs>
